...
const I18N = (function() {
    ...
    dict['auto.item'] = { tr: 'Oge 01', en: 'Item 01' };
    dict['auto.overview.h3'] = { tr: 'Tasima ve Muhafaza', en: 'Transport & Storage' };
    dict['kbrnnum.feature.1'] = { tr: 'Hava, su, toprak, cisim, yuzey ve materyal uzerinden ornekleme duzeni saglar.', en: 'Provides sampling from air, water, soil, objects, surfaces, and materials.' };
    dict['kbrnnum.feature.2'] = { tr: 'Biyolojik ve kimyasal tupler kendi renk kodlarinda siniflandirilmistir.', en: 'Biological and chemical tubes are color-coded for easy identification.' };
    dict['kbrnnum.feature.3'] = { tr: 'Steril tupler bakteri ve virus numunesi alma/tasima icin uygundur.', en: 'Sterile tubes suitable for collecting and transporting bacteria and virus samples.' };
    dict['kbrnnum.feature.4'] = { tr: 'Su sizdirmaz canta icinde tum malzemeler sabitlenmis ve etiketlenmistir.', en: 'All materials are secured and labeled inside a waterproof case.' };
    dict['kbrnnum.feature.5'] = { tr: 'Paslanmaz celik ve PP malzemeden uretilmis numune alma ekipmanlari icerir.', en: 'Includes sampling equipment manufactured from stainless steel and PP materials.' };
    dict['kbrnnum.feature.6'] = { tr: 'Kullanim formlari, etiketler ve ambalajlama malzemeleri tanimlama surecini destekler.', en: 'Usage forms, labels, and packaging materials support the identification process.' };
    dict['kd.feature.1'] = { tr: 'Hemostatik aktifler yara yuzeyinde hizli pihtilasma surecini destekleyecek sekilde tasarlanir.', en: 'Hemostatic actives are designed to support rapid clotting on wound surfaces.' };
    dict['kd.feature.2'] = { tr: 'Farkli yara ve mudahale senaryolari icin urun formu cesitlendirilebilir.', en: 'Product form can be diversified for different wound and intervention scenarios.' };
    dict['kd.feature.3'] = { tr: 'Askeri travma, acil servis ve saha kullanimi hedeflenir.', en: 'Targeted for military trauma, emergency rooms, and field use.' };
    dict['kd.feature.4'] = { tr: 'Urunlesme surecinde stabilite, sterilite ve uygulama kolayligi birlikte degerlendirilir.', en: 'Stability, sterility, and ease of application are evaluated together during productization.' };
